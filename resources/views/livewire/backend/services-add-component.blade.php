            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
               ...
               @endif
                <div class="bg-white overflow-hidden shadow-xl rounded p-4">
                    <h2 class="font-extrabold text-teal-900 hover:text-teal-600">Add New Service</h2>
                    <form wire:submit.prevent ="addService">
                     <div class="form-group">
                       ...
                       <select name="title" id="title" class="form-control" wire:model='title'>
                        ...
                        <option value="webapi" >Web Api Development</option>
                        <option value="webper" >Web Performance</option>
                        <option value="websec" >Web Security</option>
                        <option value="webman" >Web Maintenance and Support</option>
                       </select>
                        @error('title')
