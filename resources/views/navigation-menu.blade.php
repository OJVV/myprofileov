            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center mx-2">
                    <a href="{{ route('dashboard') }}">
                        <img src="{{asset('assets/img/ovshop.jpg')}}" alt="Logo" class="rounded-full block h-9 w-auto">
                    </a>
                </div>

                <!-- Navigation Links -->
               
                <div class="shadow items-center mx-2 ">
                   <ul class=" pt-2 mb-1 flex flex-row ml-2 text-2xl" id="myHeader">
                    ...
                    <li class="nav-item ml-2">
                        <a href="{{route('messages')}}" class="nav-link  text-black{{request()->is('messages') ? 'active' :''}}">
                        Messages</a>
                    </li>
